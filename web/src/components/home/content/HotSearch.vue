            ...
            <div class="bottom">
                ...
                <div class="option-item">
                    <div class="comment" @click="openComment(hot.id)">
                        <router-link :to="{name:'hot'}" class="navbar-item">
                            <svg class="icon sanjiao" aria-hidden="true">
                                <use xlink:href="#icon-pinglun1"></use>
                            </svg>
                        </router-link>
                        <router-link :to="{name:'hot'}" class="navbar-item" @click="getComments(hot.user, hot.id), openComment">评论</router-link>
                    </div>
                    <div class="share">
                        <router-link :to="{name:'hot'}" class="navbar-item">
                            <svg class="icon sanjiao" aria-hidden="true">
                        ...
                        <router-link :to="{name:'hot'}" class="navbar-item">分享</router-link>
                    </div>
                    <div class="collect" @click="changeColor">
                        <router-link :to="{name:'hot'}" class="navbar-item" v-if="color">
                            <svg class="icon sanjiao" aria-hidden="true">
                                <use xlink:href="#icon-shoucang"></use>
                            </svg>
                        </router-link>     
                        <router-link :to="{name:'hot'}" class="navbar-item" v-else>
                            <svg class="icon sanjiao" aria-hidden="true">
                                <use xlink:href="#icon-shoucang-copy"></use>
                            </svg>
                        </router-link>                   
                        <router-link :to="{name:'hot'}" class="navbar-item">收藏</router-link>
                    </div>
                    <div class="like" @click="changeLike">
                        <router-link :to="{name:'hot'}" class="navbar-item love" v-if="like">
                            <svg class="icon sanjiao" aria-hidden="true">
                        ...
                        <router-link :to="{name:'hot'}" class="navbar-item">喜欢</router-link>
                    </div>
                    <div class="more">
                        <router-link :to="{name:'hot'}" class="navbar-item">
                            <svg class="icon sanjiao" aria-hidden="true">
                                ...
                                <div class="one">
                                    ...
                                    <div class="onefoot">
                                        <div class="reanswer">
                                            ...
                                            <router-link :to="{name:'hot'}" class="navbar-item">回复</router-link>
                                        </div>
                                        <div class="dianzan">
                                            <svg class="icon sanjiao" aria-hidden="true">
                                                <use xlink:href="#icon-dianzan1"></use>
                                            </svg>
                                            <router-link :to="{name:'hot'}" class="navbar-item">{{comment.beloved}}</router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
